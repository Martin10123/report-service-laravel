...
const props = defineProps({
    sedes: Array,
    sedePreseleccionada: Object,
    sedeBloqueada: Boolean,
});

const form = useForm({
    sede_id: props.sedePreseleccionada?.id || '',
    numero_servicio: '',
    fecha: '',
    hora: '',
    observaciones: '',
    ...
    <AppLayout title="Crear Servicio">
        <template #header>
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Crear Nuevo Servicio</h1>
                    <p class="mt-1 text-sm text-gray-600">Registra un nuevo servicio en el sistema</p>
                </div>
            </div>
        </template>
            ...
            <div class="overflow-hidden rounded-lg bg-white shadow">
                <form @submit.prevent="submit" class="space-y-6 p-6">
                    ...
                    <div>
                        ...
                        <div v-if="sedeBloqueada && sedePreseleccionada" class="mt-1">
                            <div class="flex items-center gap-2 rounded-lg border border-gray-300 bg-gray-50 px-3 py-2">
                                ...
                                <span class="font-medium text-gray-700">{{ sedePreseleccionada.nombre }}</span>
                    ...
                    <div>
                        ...
                        <p v-else class="mt-1 text-sm text-gray-500">Opcional. Deja vacío para generarlo automáticamente.</p>
                    </div>
