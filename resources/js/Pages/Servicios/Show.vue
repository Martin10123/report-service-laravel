...
const todasLasSecciones = [
    ...
    { 
        key: 'area_a4', 
        titulo: 'Área A4', 
        descripcion: props.tieneParqueadero ? 'Exteriores, vehículos e Iglekids' : 'Exteriores e Iglekids',
        ruta: 'conteo-a4',
...
// Filtrar secciones según las áreas disponibles
const secciones = computed(() => {
    return todasLasSecciones.filter(seccion => {
        // Siempre mostrar secciones marcadas como siempreMostrar
        if (seccion.siempreMostrar) return true;
    ...
    <AppLayout title="Detalles del servicio">
        <div class="space-y-4">
            ...
            <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                ...
                <Link :href="route('informe-final', { servicio_id: servicio.id })" class="inline-flex">
                    <PrimaryButton>
